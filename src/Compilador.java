//Librerias
import com.formdev.flatlaf.FlatIntelliJLaf;// Importa una biblioteca para el diseño de la interfaz gráfica 
import compilerTools.CodeBlock;// Importa una clase para manejar bloques de código
import javax.swing.UIManager;// Biblioteca para cambiar el aspecto (Look and Feel) de la interfaz de usuario
import javax.swing.UnsupportedLookAndFeelException;// Excepción que se lanza si el Look and Feel no es soportado
import compilerTools.Directory;// Clase para manejar directorios y archivos en el proyecto
import compilerTools.ErrorLSSL;// Clase para manejar errores en el compilador
import compilerTools.Functions;// Clase que contiene varias funciones auxiliares
import compilerTools.Grammar;// Clase para manejar las reglas gramaticales del compilador
import compilerTools.Production;// Clase para manejar producciones o reglas en la gramática
import compilerTools.TextColor;// Clase para manejar el color del texto 
import compilerTools.Token; // Clase para manejar los tokens del código 
import java.awt.Color;// Biblioteca para manejar colores en la interfaz gráfica
import java.awt.event.ActionEvent;// Clase para manejar eventos de acciones como presionar botones
import java.awt.event.WindowAdapter;// Clase para escuchar eventos de la ventana
import java.awt.event.WindowEvent;// Evento que ocurre cuando una ventana es manipulada
import java.io.BufferedReader;// Clase para leer texto de un archivo de manera eficiente
import java.io.File;// Clase que representa un archivo o directorio
import java.io.FileInputStream;// Clase para leer bytes de un archivo
import java.io.FileNotFoundException;// Excepción que se lanza cuando un archivo no se encuentra
import java.io.FileOutputStream;// Clase para escribir bytes a un archivo
import java.io.IOException;// Excepción general para errores de entrada/salida
import java.io.InputStreamReader;// Clase que convierte un flujo de bytes en caracteres
import java.util.ArrayList;// Clase que representa una lista dinámica
import java.util.HashMap;// Clase que representa un mapa clave-valor
